 ...
 * @author josej
 */
public class ConsumidorSesion implements AutoCloseable {

    private com.rabbitmq.client.Connection connection;
    private com.rabbitmq.client.Channel channel;
    private String requestQueueName = "rpc_queueSesiones";

    public ConsumidorSesion() throws IOException, TimeoutException {
