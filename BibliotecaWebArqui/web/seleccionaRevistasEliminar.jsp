        ...
        <script>
            ...
            boton.addEventListener('click', function () {
                ...
                if (revistasSeleccionadas.length > 0) {
                    let confirmacion = confirm('¿Está seguro de que desea eliminar las revistas seleccionadas?');
                    if (confirmacion) {
                        let urls = [];
                        ...
                        Promise.all(
                            ...
                            alert('Las revistas seleccionadas se eliminaron correctamente.');
                            window.location.href = "despliegaRevistas.jsp";
                        }).catch(error => {
                            alert(`Se produjo un error al intentar eliminar las revistas seleccionadas: ${error.message}`);
                        });
                    }
                } else {
